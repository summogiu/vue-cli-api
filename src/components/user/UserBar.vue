...
.open-products-style-box:hover .products-style-box{
    opacity: 1;
    visibility: visible;
}
.open-products-style-box:hover .all-products{
    pointer-events:all;
}
...
.rotate-enter-to, .rotate-leave-from{
  opacity: 1;
  scale: 1;
}
.rotate-leave-to {
